...
const Concept4Screen: React.FC = () => {
  ...
  }, [currentStep, consentAccepted, treatmentSelected, supplySelected, showUpsell]);
  ...
  const handleContinue = () => {
    ...
    // Handle supply selection — show upsell for 1/2 month, or go to plan page for 3 month
    if (currentStep === 1 && consentAccepted && treatmentSelected && !supplySelected) {
      if (selectedSupply === '1-month' || selectedSupply === '2-month') {
        setShowUpsell(true);
        return;
      }
          ...
          <View style={styles.upsellOverlay}>
            <View style={styles.upsellTop}>
              <Image
                ...
                resizeMode="contain"
              />
              <View style={styles.upsellImageContainer}>
                <Image
                  source={require('../images/mountain range.png')}
                  style={styles.upsellImage}
                  resizeMode="contain"
                />
              </View>
            </View>
            <View style={styles.upsellTextFrame}>
              <Text style={styles.upsellHeading}>We recommend a{'\n'}3 month plan</Text>
              <Text style={styles.upsellBody}>Based on our data, patients that buy a 3 month plan lose up to 5% more weight.</Text>
              <Text style={styles.upsellSavings}>Save an extra £10 per month</Text>
            </View>
            <View style={styles.upsellButtonFrame}>
              <PIPPButton
                title="Switch to 3 month plan"
                onPress={() => {
                  setSelectedSupply('3-month');
                  setShowUpsell(false);
                  setSupplySelected(true);
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Text style={styles.upsellSecondaryButtonText}>Skip recommendation</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
