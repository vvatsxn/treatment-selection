...
if (typeof document !== 'undefined') {
  let el = document.getElementById('oc-step-css-c1');
  if (!el) { el = document.createElement('style'); el.id = 'oc-step-css-c1'; document.head.appendChild(el); }
      ...
      <ContentContainer>
        ...
        <View style={s.section}>
          <View style={s.sectionHeader}>
            ...
            <TouchableOpacity style={s.sectionViewAll} onPress={() => navigate('/phlo/concept-1/my-account/orders')}>
...
const OC_STATUS: Record<string, {
  ...
  ORDER_PLACED: {
    ...
    calloutHeadline: "We've received your order",
    calloutBody: "Our prescriber will review your order next. We'll keep you updated here.",
    ctaLabel: null, ctaRoute: null,
  },
  ON_HOLD: {
    label: 'Order placed', stepIndex: 0, variant: 'hold',
    calloutHeadline: 'We need some more information',
    calloutBody: 'Supporting information is still needed before we can complete your review. Please check your email for any more information.',
  ...
  IN_REVIEW_NO_ACTION: {
    label: 'In review', stepIndex: 1, variant: 'none',
    calloutHeadline: '', calloutBody: null,
    ctaLabel: null, ctaRoute: null,
  },
  IN_REVIEW_EVIDENCE_REQUIRED: {
    label: 'In review', stepIndex: 1, variant: 'warning',
    calloutHeadline: 'We need some more information',
    calloutBody: 'Supporting information is still needed before we can complete your review. Please check your email for any more information.',
    ctaLabel: 'Take photos', ctaRoute: '/phlo/photo-capture/upload',
    ctaSecondary: true,
  ...
  IN_REVIEW_UPLOADED: {
    label: 'In review', stepIndex: 1, variant: 'success',
    calloutHeadline: 'Your information has been received',
    calloutBody: 'This information will help our prescribers safely and effectively review your order.',
    ctaLabel: null, ctaRoute: null,
  },
  PRESCRIBER_REVIEW: {
    label: 'In review', stepIndex: 1, variant: 'pending',
    calloutHeadline: 'Your order is being reviewed',
    calloutBody: "Your information is currently with our clinical team. We'll keep you updated if anything changes.",
    ctaLabel: null, ctaRoute: null,
  },
  PREPARING_YOUR_ORDER: {
    label: 'Preparing', stepIndex: 2, variant: 'approved',
    calloutHeadline: "We're getting your order ready",
    calloutBody: 'Your prescription has been approved and our pharmacy team is preparing your medication.',
    ctaLabel: null, ctaRoute: null,
  },
  REJECTED: {
  ...
  DISPATCHED: {
    ...
    calloutHeadline: 'Your order is on its way',
    calloutBody: 'Your parcel has now been collected by Royal Mail and is making its way to you. You can follow it using the tracking link below.',
...
const s = StyleSheet.create({
  ...
  ocCalloutBody: {
    fontFamily: "'Inter', sans-serif",
    fontSize: 12, lineHeight: 18, fontWeight: '400',
    color: '#07073D',
  },
